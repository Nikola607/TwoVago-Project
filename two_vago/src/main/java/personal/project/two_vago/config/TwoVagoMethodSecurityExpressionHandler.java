...
public class TwoVagoMethodSecurityExpressionHandler extends DefaultMethodSecurityExpressionHandler {
    private final OfferService offerService;

    public TwoVagoMethodSecurityExpressionHandler(OfferService offerService) {
